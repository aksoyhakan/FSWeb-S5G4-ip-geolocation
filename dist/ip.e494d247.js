  ...
  _ipAdresimiAl = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 2:
          return _context.abrupt("return", benimIP);
        case 3:
        case "end":
...
var newIp;
var ipAddress = ipAdresimiAl().then(function (response) {
  ...
  function domMaker(newObject) {
    ...
    ulke.textContent = "".concat(newObject.ülke, " (").concat(newObject.ülkeKodu, ")");
    cardInfoDiv.appendChild(ulke);
    var enlem = document.createElement("p");
    enlem.textContent = "Enlem: ".concat(newObject.enlem, " Boylam: (").concat(newObject.boylam, ")");
